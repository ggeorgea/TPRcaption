...
class DecoderRNN(nn.Module):
    def __init__(self, vocab_size, embed_size=256, hidden_size=512,num_layers=2):
        ...
        self.lstmS = nn.LSTM(embed_size, hidden_size,num_layers,batch_first = True,dropout = 0.4)
        self.lstmU = nn.LSTM(embed_size, hidden_size,num_layers,batch_first = True,dropout = 0.4)
